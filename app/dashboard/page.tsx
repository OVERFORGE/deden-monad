...
// ✅ UPDATED: Import chain config for Monad Testnet
...
export default function UserDashboard() {
  ...
  // ✅ UPDATED: Get block explorer URL from chainConfig for Monad Testnet
  const getExplorerUrl = (chainId: number | null, txHash: string) => {
    if (!chainId) {
      console.warn('[Dashboard] No chainId provided for explorer URL');
      return '#';
    }
    
    const chain = chainConfig[chainId];
    if (!chain) {
      console.warn(`[Dashboard] Chain ${chainId} not configured`);
      return '#';
    }
  ...
  // ✅ UPDATED: Get chain name from chainConfig for Monad Testnet
    ...
    <div className="max-w-5xl mx-auto p-5 md:p-10 min-h-screen">
      ...
      <div className="mb-10">
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-6">
          ...
          {/* Wallet Connection Card - ✅ UPDATED for Monad */}
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-xl border-2 border-blue-200">
            <h3 className="text-lg font-semibold mb-3 text-gray-900 flex items-center gap-2">
              <span className="text-2xl">💼</span> Wallet (Monad Testnet)
            </h3>
            ...
            {isWalletLinked ? (
              ...
              <div className="space-y-3">
                <p className="text-gray-700 text-sm mb-3">
                  Link your wallet to manage bookings and make crypto payments on Monad Testnet.
                </p>
            ...
            return (
              ...
              >
                ...
                <div className="border-t border-gray-200 pt-5 mb-5">
                  ...
                  {/* ✅ UPDATED: Transaction Hash for Monad Testnet */}
